...
<a href="pindex#about"><font size="4"> <<ရှေ့သို့ &nbsp;</font></a>
  ...
  <div class="row col-12 card justify-content-center">
   <div class="work_1 clearfix mt-3" data-aos="fade-right" data-aos-delay="50">
   <h4 style="color:navy;"><b><?php echo $pgdName; ?>၏ ရင်ပြင်တော်ပေါ်ရှိဖူးမြော်လေ့လာနိုင်သောနေရာများအား ရွေးချယ်ကြည်ရှု့ရန်</b></h4>	
   </div>
   <div class="row d-flex g-2 mb-5">   
          ...
          while ($row =( mysqli_fetch_array($result))) {
            ?>            
    <div class="card col-10 rounded shadow shadow mt-5 ms-5 g-0 justify-content-center" style="max-width: 540px; object-fit:contain; background-color:none;">
      <div class="row justify-content-center">
        <div class="col-md-5 ms-0 " data-aos="fade-left" data-aos-delay="50">
          <?php
          $cat="ဖူးမြော်လေ့လာနိုင်သောနေရာများ";
          $sub=urlencode($row['subCatName']);
          $photo="admin/". $row["icon"];
        echo "<a href=detail?title=$sub&catName=$cat>";
          echo '<img src="'.$photo.'" class="img-responsive rounded shadow shadow" height="270" width="200">';
          echo '</a>';
          ?>    
       </div>
       <div class="col-md-7" style="line-height:80%;" data-aos="zoom-in" data-aos-delay="50" align="left">
          ...
          <p class="card-text big" align ="justify"><?php 
            ...
            echo "<h6>".$substr.".......</h6></p>";
            echo "<p align='left'><a href=detail?title=$sub&catName=$cat class='btn btn-primary'>ပိုမိုဖတ်ရှုရန်</a></p>";?>      
          </div>
        </div>
      </div>
   </div> 
