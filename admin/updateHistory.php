        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Update History</span></li>
            </ol>
          </nav>
          <div align="right">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10">
            <div class="card mb-4 mx-4">
              <div class="card-title"><h3><b>သမိုင်းကြောင်းများပြင်ရန်</b></h3></div>
              <div class="card-body p-7">
           <form action="updateHistory" method="post" enctype="multipart/form-data">     
            <?php
                  $h_id=$_GET['hid'];
                  $pid=$_GET['pid']; 
                  $result = mysqli_query($conn,"SELECT * FROM history where p_id='$pid' and h_id='$h_id'");
                   if($row=mysqli_fetch_array($result)){
                  ?>                         
                ...
                <div class="input-group mb-3 mt-4" style="font-size:.5rem;">
                  ...
                  <?php                  
                  $result = mysqli_query($conn,"SELECT * FROM history where p_id='$p_id' and h_id='$h_id'");
