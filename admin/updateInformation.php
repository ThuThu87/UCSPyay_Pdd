        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Update Information</span></li>
            </ol>
          </nav>
          <div align="right">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10">
            <div class="card mb-4 mx-4">
              <div class="card-title"><h3><b>သတင်းအချက်အလက်များပြင်ရန်</b></h3></div>
              <div class="card-body p-7">
           <form action="updateInformation" method="post" enctype="multipart/form-data">
          
                      
                  <?php
                  $id=$_GET['id'];
                  $p_id=$_GET['pid']; 
                  $result = mysqli_query($conn,"SELECT * FROM information where p_id='$p_id' and id='$id'");
                   if($row=mysqli_fetch_array($result)){
                  ?>                         
                ...
                <div class="input-group mb-3 mt-4"><span class="input-group-text">
                  <img  src="assets/img/icon1/p3.png" alt="" width="30px" height="20px"></span> 
                  <input type="text" class="form-control" name="title" id="" rows="5" value="<?php echo $row['title'];?>" disabled>
                  <input type="hidden" class="form-control" name="id" id="" rows="5" value="<?php echo $row['id'];?>">
                </div>
                <div class="input-group mb-3 mt-4"><span class="input-group-text">
...
<?php 
  ...
  else
  {
           ...
           $qry="Update information set detail_info='$detail_info',upload_on=NOW() where id='$Id' "; 
