...
<div class="header-divider"></div>
     ...
     <br>
           <form action="insertSubmenu" method="post" enctype="multipart/form-data">
           ...
           <div class="input-group mb-3  mt-4">
                ...
                <div class="input-group mb-3  mt-4">
                  <span class="input-group-text px-2">
                  <img  src="assets/img/icon1/p3.png" alt="" width="30px" height="20px"></span>
                  <select class="form-select form-select-md  form-control" aria-label=".form-select-md example" name="catName" required>
                    <option selected>အမျိုးအစား</option>    
                  <?php
                  if($role==1 )  {
                  //  echo $row['website'];
                    $result = mysqli_query($conn,"SELECT * FROM category where catName<>'မြေပုံ'");
                  }
                  else if($role==2){
                     if($website==null)
                     {
                     ...
                     {                  
                      $result = mysqli_query($conn,"SELECT * FROM category where catName='ဖူးမြော်လေ့လာနိုင်သောနေရာများ'");
                     }
                  }
                   while($row=mysqli_fetch_array($result)){
                  ?>                         
                ...
                <img  src="assets/img/icon1/gallery.png" alt="" width="30px" height="20px"></span>                
                  <input class="form-control" name="image" type="file" placeholder="iconပေါ်တွင့်ထားရန်ပုံရွေးပါ" required>
                </div>


                <div class="input-group mb-3 mt-4"><span class="input-group-text">
                <img  src="assets/img/icon1/photo.png" alt="" width="30px" height="20px"></span>  
                  <input class="form-control" name="image1" type="file" placeholder="အသေးစိတ်အကြောင်းတွင်ပြရန်ပုံရွေးပါ" required>
                </div>
  ...
  else
  {
      ...
      if($pgdId=='ဘုရားအမည်'){
          echo '<script>
            ...
            window.location.href = "insertSubmenu";
            </script>';
        }
        else if($catName=="အမျိုးအစား")
        {
          echo '<script>
       ...
       case 'သမိုင်းကြောင်းများ' : { 
        ...
        case "သမိုင်းဝင်ဖြစ်ရပ်များ": { 
         ...
         { echo '<script>
          ...
          switch($catName)
          {
            case 'သမိုင်းကြောင်းများ':echo '<script>window.location.href = "viewHistory";</script>';break;
            case 'ဖူးမြော်လေ့လာနိုင်သောနေရာများ':echo '<script>window.location.href = "viewFamous";</script>';break;
            case 'သာသနာထွန်းကားမှု':echo '<script>window.location.href = "viewBuddhism";</script>';break;
            case 'ဒေသနာတော်များ':echo '<script>window.location.href = "viewEcclesiastes";</script>';break;
            case 'ခေတ်အဆက်ဆက် ပြုပြင်မွမ်းမံထိန်းသိမ်းမှုများ':echo '<script>window.location.href = "viewNational";</script>';break;
            case 'သမိုင်းဝင်ဖြစ်ရပ်များ':echo '<script>window.location.href = "viewHistoricalEvent";</script>';break;
            case 'မြေပုံ':echo '<script>window.location.href = "viewMap";</script>';break;
