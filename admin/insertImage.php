        ...
        <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>Insert Photo</span></li>
            </ol>
          </nav>
          <div align="right">
...
<?php 
  ...
  else
  {
        ...
        $qry="Insert into photo(p_id,pgdName,photo) values('','$pgdName','$image_full_path')";
        $res=mysqli_query($conn,$qry);
        if($res)     
        { //echo "<p> successfully </p>"; 
         echo '<div class="alert alert-success">Your inserted data successfully </div>';
         header("Refresh:1; URL=insertPhoto"); 
        }               
           else
            echo "<p>Not</p>";
    //mysqli_close($conn);
