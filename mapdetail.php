...
<a href="<?php echo $link; ?>"><font size="4"> << &nbsp;ရှေ့သို့</font></a>
	<div class="col-sm-12">
  <div class="container">
	 <div class="choose_4">
    ...
    <!-- <img src="img/ဆယ်ထပ်ကြီး/1.jpg" width="540" height="500" ></img><br><br> -->
      <!-- <img src="img/p3.jpg" width="540" height="400" ></img> -->
    </div>
      <br><br><h4 align="left"><?php echo $row['subCatName'];?></h4><br><br>
      <p align="justify">
 ...
 <div class="tusc pull-right">
                 ...
                 <a href=<?php echo $link;?> class="read_more">  &nbsp <<&nbsp</a>
